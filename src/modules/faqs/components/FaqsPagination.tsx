...
export default function FaqsPagination() {
  const dispatch = useAppDispatch();
  const { pagination, filters, isLoading } = useAppSelector((state) => state.faqs);
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-6 border-t border-[var(--admin-border)]">
      ...
      <div className="text-sm text-[var(--admin-text-muted)]">
        ...
        <span className="font-medium text-[var(--admin-text)]">{total}</span> FAQs
      </div>
